...
async function seed() {
  ...
  await createdDonation.addDonor(createdDonors[0])
  await createdDonation.addPool(createdPools[0])
  await createdTransaction.addVendor(createdVendors[0])
  await createdTransaction.addPool(createdPools[0])
